    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Test admin panel access and authentication</p>
        </div>

        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h2 className="text-xl font-semibold mb-4 text-gray-900">Authentication Information</h2>
            <div className="text-gray-600">
              <p className="mb-4">This page tests admin access to the BOLES Smart Home admin panel.</p>
              <p>To test admin functionality, please sign in with an admin account.</p>
            </div>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-lg font-semibold mb-4 text-gray-900">Admin Access Rules</h3>
